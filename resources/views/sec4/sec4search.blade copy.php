                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-position">
                                        <button class="btn btn-gradient-warning newFont" data-toggle="modal"
                                            data-target="#downloadindicator"><i class="mdi mdi-cloud-download"></i>
                                        </button>
                                    </div>
                                    <br>
                                    <br>
                                                ...
                                                <tbody>
                                                    <tr class="d-flex">
                                                        ...
                                                        <td class="col-sm-4 break textleft">
                                                            {{$data->indicator_stratetegic_name}} </td>
